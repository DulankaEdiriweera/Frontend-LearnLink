    ...
    useEffect(() => {
        const fetchNotifications = async () => {
            try {
                ...
                const mySkills = skillsResponse.data.filter(skill =>
                    skill.user && skill.user.email === tokenPayload.sub
                );
                        ...
                        <ul className="space-y-4">
                            {notifications.map((notification) => (
                                <li
                                    ...
                                    onClick={() => navigateToPlan(notification.context, notification.idRef)}
                                >
                                        ...
                                        {notification.type === "like" ? (
                                            <div className="flex items-center mb-1">
                                                ...
                                                <p className="text-gray-800">
                                                    <span className="font-semibold">{notification.username}</span> liked your{" "}
                                                    {notification.context === "plan" ? "learning plan" : "skill post"}{" "}
                                                    <span className="font-semibold text-blue-600">{notification.title}</span>
                                                </p>
                                            </div>
                                        ) : (
                                            <div>
                                                <div className="flex items-center mb-1">
                                                    ...
                                                    <p className="text-gray-800">
                                                        <span className="font-semibold">{notification.username}</span> commented on your{" "}
                                                        {notification.context === "plan" ? "learning plan" : "skill post"}{" "}
                                                        <span className="font-semibold text-blue-600">{notification.title}</span>
                                                    </p>
                                                </div>
