        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="relative w-full">
                ...
                <button
                    ...
                    className="absolute top-4 left-4 bg-white rounded-full p-2 shadow-lg hover:bg-gray-200"
                >
            ...
            <div className="mt-16 px-6 lg:px-16">
                ...
                <div className="mt-4 flex space-x-8 font-semibold text-gray-700">
                    <span>{user.followers} <span className="text-gray-500">Followers</span></span>
                    <span>{user.following} <span className="text-gray-500">Following</span></span>
                </div>
